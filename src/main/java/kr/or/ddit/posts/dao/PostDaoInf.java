...
public interface PostDaoInf {
	...
	* @param map
	* @return
	* Method 설명 : 삭제여부가 false인 해당게시판의 게시글을 조회
	 */
	List<PostVo> selectPostPageList(Map<String, Object> map);
	...
	* Method 설명 :
	...
	/**
	 * 
	* Method : selectPostTnt
	* 최초작성일 : 2018. 7. 20.
	* 작성자 : PC11
	* 변경이력 :
	* @param board_code
	* @return
	* Method 설명 : 해당게시판의 게시글들의 수 조회
	 */
	int selectPostTnt(String board_code);
